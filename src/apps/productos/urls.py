...
from apps.productos.views import index, Producto, ListProducto, CreateProducto, UpdateProducto, DetailViewProducto, DeleteProducto
...
urlpatterns = [
    #Productos
    url(r'^productos$', Producto.as_view(), name='productos'),
